         ...
         <div class="container flex flex-wrap justify-between items-center mx-auto">
             ...
             <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                 <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                     <li>
                         <a href="/index" class="block py-2 pr-4 pl-3  rounded md:bg-transparent text-blue-700 md:p-0" aria-current="page">Home</a>
                     </li>
                     <li>
                         <a href="/login" class="block py-2 pr-4 pl-3 rounded md:bg-transparent text-blue-700  md:p-0" aria-current="page">Login</a>
                     </li>
