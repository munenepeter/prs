...
<body>
    <div class="header">
        ...
        <p class="company-description">Generated by: <br/> Digital Divide Data <br/>Productivity Reporting System</p>   
        </div>
        ...
        <table class="report-table">
            ...
            <tfoot style="font-size:12px;">
                <tr style="font-weight: 800">
                    <td></td>
                 [{{--   <td>Total Entries: {{ $totalProjects <= 0 ? 'N/A' : $totalProjects }} </td> --}}
                    <td>{{ $totalTasks <= 0 ? 'N/A' : $totalTasks }} Tasks</td>
                    <td></td>
                    <td> {{ $totalUnits <= 0 ? 'N/A' : $totalUnits }} Total</td> 
                    <td>Total: {{ $totalDuration->forHumans(['short' => true]) }}</td>
                    <td>Total: {{ $totalUnitshr <= 0 ? 'N/A' : $totalUnitshr }} </td>
                            
                        <td colspan="4">Above Target: {{ $aboveTarget ?? 'N/A' }}
                        <br/>
                        Below Target: {{ $belowTarget ?? 'N/A' }}
                        <br/>
                    On Target: {{ $onTarget ?? 'N/A' }}
