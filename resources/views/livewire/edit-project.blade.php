<div>
	...
	>
		...
		<div class="uk-grid-margin uk-first-column">
			...
			<x-select wire:model.defer="project.status"
					  id="project_status"
					  choose_option="Choose the project status"
					  :hasError="$errors->has('project.status')"
		...
		<div class="uk-grid-margin uk-first-column">
			...
			/>
			<x-textarea wire:model.defer="project.description"
						id="project_description"
						placeholder="Provide some brief information on the project."
						:hasError="$errors->has('project.description')"
			/>
		...
		@if (!$create_new_client)
			<div class="uk-grid-margin uk-first-column">
				...
				/>
				<x-select wire:model.defer="project.client.id"
						  id="client"
						  choose_option="Choose a client"
						  :hasError="$errors->has('project.client.id')"
		...
		<div class="uk-grid-margin uk-first-column">
			...
			/>
			<x-select wire:model.defer="project.manager.id"
					  id="project_manager"
					  choose_option="Choose a project manager"
					  :hasError="$errors->has('project.manager.id')"
